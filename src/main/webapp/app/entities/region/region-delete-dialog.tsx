...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication11App.region.delete.question">
        <Translate contentKey="jhipsterSampleApplication11App.region.delete.question" interpolate={{ id: regionEntity.id }}>
