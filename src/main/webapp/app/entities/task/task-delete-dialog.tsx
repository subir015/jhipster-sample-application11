...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication11App.task.delete.question">
        <Translate contentKey="jhipsterSampleApplication11App.task.delete.question" interpolate={{ id: taskEntity.id }}>
