...
export const JobDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication11App.job.delete.question">
        <Translate contentKey="jhipsterSampleApplication11App.job.delete.question" interpolate={{ id: jobEntity.id }}>
