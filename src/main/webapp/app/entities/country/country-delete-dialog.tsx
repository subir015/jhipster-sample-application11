...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication11App.country.delete.question">
        <Translate contentKey="jhipsterSampleApplication11App.country.delete.question" interpolate={{ id: countryEntity.id }}>
